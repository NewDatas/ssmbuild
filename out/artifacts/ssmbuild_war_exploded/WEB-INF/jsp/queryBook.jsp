...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/allBook">显示全部书籍列表</a>
        </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="book" items="${requestScope.get('list')}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/book/updateBookUI?id=${book.getBookID()}">编辑</a>
                            |
